...
------------------------------------------------------
`numpy.repeat` now converts the ``repeats`` argument using same-kind
...
raised a ``TypeError`` about unsafe casting, while an equivalent list of
Python integers was accepted.
